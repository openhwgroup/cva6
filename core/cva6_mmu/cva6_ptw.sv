    ...
    case (state_q)
      ...
      PTE_LOOKUP: begin
        ...
        if (data_rvalid_q) begin
          ...
          // Invalid PTE
          // -------------
          // If pte.v = 0, or if pte.r = 0 and pte.w = 1, or if pte.reserved != 0 (bits [60:54]) in sv39/sv39x4, raise a page-fault.
          // pte.pbmt (bits [62:61]) is intentionally excluded from this check per the Svpbmt extension.
