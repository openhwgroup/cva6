  ...
  always_comb begin : PUEQueueManagement
    ...
    case (pue_state_q)
      IDLE: begin
        ...
        end else if ((accessed_queue_status_q != 0)) begin
      ...
      D_BIT_AMO_SEND: begin
        if(dirty_queue_q[dirty_queue_read_pointer_d].committable && dirty_queue_q[dirty_queue_read_pointer_d].valid) begin
          ...
          amo_req_o.operand_a = {
            {64 - CVA6Cfg.PLEN{1'b0}}, dirty_queue_q[dirty_queue_read_pointer_d].amo_req.pte_paddr
          };
          amo_req_o.operand_b = {
            {64 - CVA6Cfg.PLEN{1'b0}}, dirty_queue_q[dirty_queue_read_pointer_d].amo_req.data
          };
      ...
      A_BIT_AMO_SEND: begin
        if (accessed_queue_q[accessed_queue_read_pointer_d].valid) begin
          ...
          amo_req_o.operand_a = {
            ...
            accessed_queue_q[accessed_queue_read_pointer_d].amo_req.pte_paddr
          };
          amo_req_o.operand_b = {
            {64 - CVA6Cfg.PLEN{1'b0}}, accessed_queue_q[accessed_queue_read_pointer_d].amo_req.data
          };
          amo_req_o.pma = 2'b00;  // follow the PMA of the page-table entry
