...
export COMPLIANCE_REPO=https://github.com/riscv-non-isa/riscv-arch-test
export COMPLIANCE_BRANCH=riscof-dev
export COMPLIANCE_HASH=7907c462c700279c5d75ec5e6042f762dcb95a25
...
cd cva6/sim
python3 cva6.py --testlist=../tests/testlist_riscv-arch-tests-$DV_TARGET.yaml --target $DV_TARGET --iss_yaml=cva6.yaml --iss=$DV_SIMULATORS $DV_OPTS
cd -
