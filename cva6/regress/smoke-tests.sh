...
python3 cva6.py --target rv64gc --iss=veri-uvm,spike --iss_yaml=cva6.yaml --c_tests ../tests/custom/hello_word/hello_word.c --gcc_opts "-g ../tests/custom/common/syscalls.c ../tests/custom/common/crt.S -I../tests/custom/env -I../tests/custom/common -T ../tests/custom/common/test.ld"
