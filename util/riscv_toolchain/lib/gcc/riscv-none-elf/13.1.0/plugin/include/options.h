...
enum opt_code
{
  ...
  OPT_list = 1883,                           /* -list */
  OPT_mabi_ = 1884,                          /* -mabi= */
  OPT_malign_data_ = 1885,                   /* -malign-data= */
  OPT_march_ = 1886,                         /* -march= */
  OPT_mbig_endian = 1887,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1888,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1889,                       /* -mcmodel= */
  OPT_mcpu_ = 1890,                          /* -mcpu= */
  OPT_mcsr_check = 1891,                     /* -mcsr-check */
  OPT_mdiv = 1892,                           /* -mdiv */
  OPT_mexplicit_relocs = 1893,               /* -mexplicit-relocs */
  OPT_mfdiv = 1894,                          /* -mfdiv */
  OPT_misa_spec_ = 1895,                     /* -misa-spec= */
  OPT_mlittle_endian = 1896,                 /* -mlittle-endian */
  OPT_mplt = 1897,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1898,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1899,                         /* -mrelax */
  OPT_mriscv_attribute = 1900,               /* -mriscv-attribute */
  OPT_msave_restore = 1901,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1902,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1903,             /* -msmall-data-limit= */
  ...
  OPT_mtune_ = 1908,                         /* -mtune= */
  OPT_n = 1909,                              /* -n */
  OPT_name_sort = 1910,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1911,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1912,              /* -no-integrated-cpp */
  OPT_no_pie = 1913,                         /* -no-pie */
  OPT_nocpp = 1914,                          /* -nocpp */
  OPT_nodefaultlibs = 1915,                  /* -nodefaultlibs */
  OPT_nolibc = 1916,                         /* -nolibc */
  OPT_nophoboslib = 1917,                    /* -nophoboslib */
  OPT_nostartfiles = 1918,                   /* -nostartfiles */
  OPT_nostdinc = 1919,                       /* -nostdinc */
  OPT_nostdinc__ = 1920,                     /* -nostdinc++ */
  OPT_nostdlib = 1921,                       /* -nostdlib */
  OPT_nostdlib__ = 1922,                     /* -nostdlib++ */
  OPT_o = 1923,                              /* -o */
  OPT_objects = 1924,                        /* -objects */
  OPT_p = 1925,                              /* -p */
  OPT_pass_exit_codes = 1926,                /* -pass-exit-codes */
  /* OPT_pedantic = 1927, */                 /* -pedantic */
  OPT_pedantic_errors = 1928,                /* -pedantic-errors */
  OPT_pg = 1929,                             /* -pg */
  OPT_pie = 1930,                            /* -pie */
  OPT_pipe = 1931,                           /* -pipe */
  OPT_print_file_name_ = 1932,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1933,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1934,          /* -print-multi-directory */
  OPT_print_multi_lib = 1935,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1936,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1937,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1938,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1939,               /* -print-prog-name= */
  OPT_print_search_dirs = 1940,              /* -print-search-dirs */
  OPT_print_sysroot = 1941,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1942,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1943,                    /* -print-value */
  OPT_quiet = 1944,                          /* -quiet */
  OPT_r = 1945,                              /* -r */
  OPT_remap = 1946,                          /* -remap */
  OPT_reverse_sort = 1947,                   /* -reverse-sort */
  OPT_s = 1948,                              /* -s */
  OPT_save_temps = 1949,                     /* -save-temps */
  OPT_save_temps_ = 1950,                    /* -save-temps= */
  OPT_shared = 1951,                         /* -shared */
  OPT_shared_libgcc = 1952,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1953,               /* -shared-libphobos */
  OPT_size_sort = 1954,                      /* -size-sort */
  /* OPT_specs = 1955, */                    /* -specs */
  OPT_specs_ = 1956,                         /* -specs= */
  OPT_static = 1957,                         /* -static */
  OPT_static_libasan = 1958,                 /* -static-libasan */
  OPT_static_libgcc = 1959,                  /* -static-libgcc */
  OPT_static_libgfortran = 1960,             /* -static-libgfortran */
  OPT_static_libgm2 = 1961,                  /* -static-libgm2 */
  OPT_static_libgo = 1962,                   /* -static-libgo */
  OPT_static_libhwasan = 1963,               /* -static-libhwasan */
  OPT_static_liblsan = 1964,                 /* -static-liblsan */
  OPT_static_libmpx = 1965,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1966,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1967,               /* -static-libphobos */
  OPT_static_libquadmath = 1968,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1969,               /* -static-libstdc++ */
  OPT_static_libtsan = 1970,                 /* -static-libtsan */
  OPT_static_libubsan = 1971,                /* -static-libubsan */
  OPT_static_pie = 1972,                     /* -static-pie */
  /* OPT_std_c__03 = 1973, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1974, */                /* -std=c++0x */
  OPT_std_c__11 = 1975,                      /* -std=c++11 */
  OPT_std_c__14 = 1976,                      /* -std=c++14 */
  OPT_std_c__17 = 1977,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1978, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1979, */                /* -std=c++1z */
  OPT_std_c__20 = 1980,                      /* -std=c++20 */
  OPT_std_c__23 = 1981,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1982, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1983, */                /* -std=c++2b */
  OPT_std_c__98 = 1984,                      /* -std=c++98 */
  OPT_std_c11 = 1985,                        /* -std=c11 */
  OPT_std_c17 = 1986,                        /* -std=c17 */
  /* OPT_std_c18 = 1987, */                  /* -std=c18 */
  /* OPT_std_c1x = 1988, */                  /* -std=c1x */
  OPT_std_c2x = 1989,                        /* -std=c2x */
  /* OPT_std_c89 = 1990, */                  /* -std=c89 */
  OPT_std_c90 = 1991,                        /* -std=c90 */
  OPT_std_c99 = 1992,                        /* -std=c99 */
  /* OPT_std_c9x = 1993, */                  /* -std=c9x */
  OPT_std_f2003 = 1994,                      /* -std=f2003 */
  OPT_std_f2008 = 1995,                      /* -std=f2008 */
  OPT_std_f2008ts = 1996,                    /* -std=f2008ts */
  OPT_std_f2018 = 1997,                      /* -std=f2018 */
  OPT_std_f95 = 1998,                        /* -std=f95 */
  OPT_std_gnu = 1999,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2000, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2001, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2002,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2003,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2004,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2005, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2006, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2007,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2008,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2009, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2010, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2011,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2012,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2013,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2014, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2015, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2016,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2017, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2018,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2019,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2020, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2021, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2022,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2023, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2024, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2025, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2026, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2027, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2028,                     /* -std=legacy */
  OPT_stdlib_ = 2029,                        /* -stdlib= */
  OPT_symbol_ = 2030,                        /* -symbol= */
  OPT_symbolic = 2031,                       /* -symbolic */
  OPT_t = 2032,                              /* -t */
  OPT_time = 2033,                           /* -time */
  OPT_time_ = 2034,                          /* -time= */
  OPT_traditional = 2035,                    /* -traditional */
  OPT_traditional_cpp = 2036,                /* -traditional-cpp */
  OPT_tree_stats = 2037,                     /* -tree-stats */
  OPT_trigraphs = 2038,                      /* -trigraphs */
  OPT_type_stats = 2039,                     /* -type-stats */
  OPT_u = 2040,                              /* -u */
  OPT_undef = 2041,                          /* -undef */
  OPT_v = 2042,                              /* -v */
  OPT_version = 2043,                        /* -version */
  OPT_w = 2044,                              /* -w */
  OPT_wrapper = 2045,                        /* -wrapper */
  OPT_x = 2046,                              /* -x */
  OPT_z = 2047,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
