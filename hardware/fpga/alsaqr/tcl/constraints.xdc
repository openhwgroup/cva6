...
create_clock -period 100.000 -name ref_clk [get_ports clk_i]

## JTAG
create_clock -period 100.000 -name tck -waveform {0.000 50.000} [get_ports jtag_TCK]
set_input_jitter tck 1.000
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets jtag_TCK_IBUF_inst/O]


# minimize routing delay
set_input_delay -clock tck -clock_fall 5.000 [get_ports jtag_TDI]
set_input_delay -clock tck -clock_fall 5.000 [get_ports jtag_TMS]
set_output_delay -clock tck 5.000 [get_ports jtag_TDO_data]
...
set_max_delay -datapath_only -from [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_resp/i_src/data_src_q_reg*/C] -to [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_resp/i_dst/data_dst_q_reg*/D] 20.000
set_max_delay -datapath_only -from [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_resp/i_src/req_src_q_reg/C]   -to [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_resp/i_dst/req_dst_q_reg/D] 20.000
set_max_delay -datapath_only -from [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_req/i_dst/ack_dst_q_reg/C]    -to [get_pins i_host_domain/i_cva_subsystem/i_dmi_jtag/i_dmi_cdc/i_cdc_req/i_src/ack_src_q_reg/D] 20.000
...
create_clock -name clk_phy -period ${tck_phy} [get_pins i_host_domain/axi_hyperbus/clk_phy_i]
set_clock_uncertainty [expr {${jitter_phy}*${tck_phy}}] clk_phy

# Create the system clock
create_clock -name clk_sys -period ${tck_sys} [get_ports i_host_domain/axi_hyperbus/clk_sys_i]
...
create_generated_clock  -name clk_tx -edges {1 2 3} -edge_shift "$clk_tx_shift $clk_tx_shift $clk_tx_shift" \
    -source i_host_domain/axi_hyperbus/i_phy/i_trx/i_delay_tx_clk_90/i_delay/clk_i \
    i_host_domain/axi_hyperbus/i_phy/i_trx/i_delay_tx_clk_90/i_delay/clk_o
...
create_generated_clock  -name clk_rx -edges {1 2 3} -edge_shift "$clk_rx_shift $clk_rx_shift $clk_rx_shift" \
    -source i_host_domain/axi_hyperbus/i_phy/i_trx/i_delay_rx_rwds_90/i_delay/clk_i \
    i_host_domain/axi_hyperbus/i_phy/i_trx/i_delay_rx_rwds_90/i_delay/clk_o
...
set cfg_from  [get_pins i_host_domain/axi_hyperbus/i_cfg_regs/cfg_o*]
set cfg_to    [get_pins i_host_domain/axi_hyperbus/i_phy/cfg_i*]
