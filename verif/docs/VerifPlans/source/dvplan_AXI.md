...
* **Feature Description**
  ...
  ARSIZE can not be equal to 3 if ARID = 1  
  ARSIZE can not be equal to 0, 1 or 2 if ARID = 0  
  ARSIZE can not be equal to 0, 1 or 2 if ARLOCK = 1
* **Verification Goals**
  
  Ensure that ARSIZE != 3 when ARID = 1  
...
* **Feature Description**
  ...
  AWSIZE can not be equal to 0 or 1 if AWLOCK = 1
* **Verification Goals**
  
  Ensure that AWSIZE != 0 or 1 when AWLOCK = 1
* **Pass/Fail Criteria:** NDY (Not Defined Yet)
* **Test Type:** NDY (Not Defined Yet)
* **Coverage Method:** NDY (Not Defined Yet)
* **Applicable Cores:** CV32A6_v0.1.0, CV32A6-step2, CV64A6-step3
