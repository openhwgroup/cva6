...
cd verif/sim
python3 cva6.py --testlist=../tests/testlist_riscv-svinval-sv39-$DV_TARGET.yaml --target $DV_TARGET --iss_yaml=cva6.yaml --iss=$DV_SIMULATORS $DV_OPTS --spike_extension=svinval
cd -