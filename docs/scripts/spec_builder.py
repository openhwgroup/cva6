...
def print_to_rst(pathout, module, ports, comments):
...
def print_to_adoc(pathout, module, ports, comments):
...
if __name__ == "__main__":
    ...
    for filein in file:
        ...
        if generate_file_type in ['rst']:
            print_to_rst(pathout, module, ports, comments)
        elif generate_file_type in ['adoc']:
            print_to_adoc(pathout, module, ports, comments)
        else:
            raise Exception("Format de sortie %s non pris en charge"%generate_file_type)
