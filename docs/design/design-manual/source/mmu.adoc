...
image:../images/mmu_in_out.png[*Figure 1:* Inputs and Outputs of CVA6
...
image:../images/mmu_major_blocks.png[*Figure 2:* Major Blocks in CVA6
...
image:../images/mmu_control_flow.png[*Figure 3:* Control Flow in CVA6
...
image:../images/in_out_tlb.png[*Figure 4:* Inputs and Outputs of CVA6
...
image:../images/cva6_tlb_entry.png[*Figure 5:* Fields in CVA6 TLB
...
image:../images/cva6_tlb_hit.png[*Figure 6:* Block diagram of CVA6 TLB
...
image:../images/sfence_vaddr_asid.png[*Figure 7:* Invalidate TLB entry
...
image:../images/sfence_x0_x0.png[*Figure 8:* Invalidate all TLB entries
...
image:../images/sfence_vaddr_x0.png[*Figure 9:* Invalidate TLB entry
...
image:../images/sfence_x0_asid.png[*Figure 10:* Invalidate TLB entry for
...
image:../images/plru_tree_indexing.png[*Figure 11:* PLRU Tree
...
image:../images/update_tree.png[*Figure 12:* Promote Entry to be
...
image:../images/replacement_entry.png[*Figure 13:* Possible path
...
image:../images/shared_tlb_in_out.png[*Figure 14:* Inputs and outputs of
...
image:../images/shared_tlb.png[*Figure 15:* CVA6 Shared TLB
...
image:../images/shared_tlb_set.png[*Figure 16:* Set opted for lookup in
...
image:../images/LZC.png[*Figure 17:* Replacement of First invalid
...
image:../images/RR.png[*Figure 18:* Entry selection for replacement
...
image:../images/ptw_in_out.png[*Figure 19:* Input and Outputs of Page
...
image:../images/ptw_state_diagram.png[*Figure 20:* State Machine Diagram
...
image:../images/ptw_idle.png[*Figure 21:* Address of Desired PTE at
...
image:../images/ptw_pte_1.png[*Figure 22:* Invalid PTE and reserved RWX
...
image:../images/ptw_iptw.png[*Figure 23:* For Instruction Page Table
Walk,scaledwidth=70.0%]

image:../images/ptw_dptw.png[*Figure 24:* Data Access Page Table
Walk,scaledwidth=70.0%]

image:../images/ptw_dptw_s.png[*Figure 25:* Data Access Page Table Walk,
...
image:../images/ptw_mis_sup.png[*Figure 26:* Misaligned Superpage
...
image:../images/ptw_nlvl.png[*Figure 27:* Address of desired PTE at next
...
image:../images/ptw_pte_flowchart.png[*Figure 28:* Flow Chart of PTE
LOOKUP State]
