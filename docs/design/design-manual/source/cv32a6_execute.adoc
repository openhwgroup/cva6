...
image:../images/ex_stage_modules.png[EX_STAGE submodules]
...
image:../images/mult_modules.png[mult submodules]
...
image:../images/load_store_unit_modules.png[load_store_unit submodules]
