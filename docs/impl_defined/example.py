...
# (result of programmaticvally adding missing tags to the original file '..../implement-handmade.yaml').
cv32a65x_conf.load_file('spec_inventory/vol2priv/implement.yaml')
