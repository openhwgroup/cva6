...
add wave -noupdate -group mem_arbiter /lsu_tb/dut/dcache_arbiter_i/*
add wave -noupdate -group mem_arbiter -group arbiter_fifo /lsu_tb/dut/dcache_arbiter_i/fifo_i/*
