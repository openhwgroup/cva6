...
%Warning-LITENDIAN: /home/cai/cache_project//sandbox/cva6/core/cvfpu/src/fpnew_pkg.sv:197:28: Big bit endian vector: left < right of bit range: [0:3]
  ...
  197 |   typedef fmt_unit_types_t [0:NUM_OPGROUPS-1] opgrp_fmt_unit_types_t;
      |                            ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:109:25: Operator ADD expects 32 bits on the RHS, but RHS's SEL generates 1 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  109 |       node = node*2 + 1 + tree[node];
      |                         ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:120:25: Operator ADD expects 32 bits on the RHS, but RHS's VARREF 'dir' generates 1 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  120 |       node = node*2 + 1 + dir;
      |                         ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:150:32: Operator XOR expects 32 bits on the LHS, but LHS's VARREF 'cache_tag' generates 26 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  150 |       fa_hash_idx = (cache_tag ^ HASH_SEED ^ (cache_tag >> $clog2(CVA6Cfg.DCACHE_SET_ASSOC))) % CVA6Cfg.DCACHE_SET_ASSOC;
      |                                ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:150:32: Operator XOR expects 32 bits on the RHS, but RHS's VARREF 'HASH_SEED' generates 26 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  150 |       fa_hash_idx = (cache_tag ^ HASH_SEED ^ (cache_tag >> $clog2(CVA6Cfg.DCACHE_SET_ASSOC))) % CVA6Cfg.DCACHE_SET_ASSOC;
      |                                ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:150:57: Operator SHIFTR expects 32 bits on the LHS, but LHS's VARREF 'cache_tag' generates 26 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  150 |       fa_hash_idx = (cache_tag ^ HASH_SEED ^ (cache_tag >> $clog2(CVA6Cfg.DCACHE_SET_ASSOC))) % CVA6Cfg.DCACHE_SET_ASSOC;
      |                                                         ^~
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:150:19: Operator ASSIGN expects 3 bits on the Assign RHS, but Assign RHS's MODDIV generates 32 bits.
                                                                                                       : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  150 |       fa_hash_idx = (cache_tag ^ HASH_SEED ^ (cache_tag >> $clog2(CVA6Cfg.DCACHE_SET_ASSOC))) % CVA6Cfg.DCACHE_SET_ASSOC;
      |                   ^
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:179:22: Operator ASSIGN expects 3 bits on the Assign RHS, but Assign RHS's ADD generates 32 bits.
                                                                                                       : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  179 |           rr_ptr_d   = i + 1;
      |                      ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:187:66: Operator MODDIV expects 32 bits on the LHS, but LHS's VARREF 'lfsr_q' generates 3 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  187 |           wt_hybrid_cache_pkg::REPL_ALGO_RANDOM: repl_way[lfsr_q % CVA6Cfg.DCACHE_SET_ASSOC] = 1'b1;
      |                                                                  ^
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:198:22: Operator ASSIGN expects 3 bits on the Assign RHS, but Assign RHS's ADD generates 32 bits.
                                                                                                       : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  198 |           rr_ptr_d   = i + 1;
      |                      ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:205:66: Operator MODDIV expects 32 bits on the LHS, but LHS's VARREF 'lfsr_q' generates 3 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  205 |           wt_hybrid_cache_pkg::REPL_ALGO_RANDOM: repl_way[lfsr_q % CVA6Cfg.DCACHE_SET_ASSOC] = 1'b1;
      |                                                                  ^
%Warning-WIDTHEXPAND: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:213:18: Operator GTE expects 32 bits on the LHS, but LHS's VARREF 'rr_ptr_d' generates 3 bits.
                                                                                                        : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem
  213 |     if (rr_ptr_d >= CVA6Cfg.DCACHE_SET_ASSOC)
      |                  ^~
...
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/cva6_icache.sv:447:43: Logical operator COND expects 1 bit on the Conditional Test, but Conditional Test's SEL generates 32 bits.
  ...
  447 |       dreq_o.user = CVA6Cfg.FETCH_USER_EN ? mem_rtrn_i.user[{cl_offset_q, 3'b0}+:CVA6Cfg.FETCH_USER_WIDTH] : '0;
      |                                           ^
%Warning-LITENDIAN: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche.sv:64:25: Big bit endian vector: left < right of bit range: [-1:0]
                                                                                                 : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche
   64 |   input  dcache_req_i_t [CVA6Cfg.NrLoadPipeRegs+CVA6Cfg.NrStorePipeRegs-1:0] dcache_req_ports_i,
      |                         ^
%Warning-LITENDIAN: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche.sv:65:25: Big bit endian vector: left < right of bit range: [-1:0]
                                                                                                 : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche
   65 |   output dcache_req_o_t [CVA6Cfg.NrLoadPipeRegs+CVA6Cfg.NrStorePipeRegs-1:0] dcache_req_ports_o,
      |                         ^
...
%Warning-SELRANGE: /home/cai/cache_project//sandbox/cva6/core/cvxif_example/instr_decoder.sv:68:102: Selection index out of range: 2:2 outside 1:0
   ...
   68 |           rs3_ready = NrRgprPorts == 3 ? (~CoproInstr[i].resp.register_read[2] || register_i.rs_valid[2]) : 1'b1;
      |                                                                                                      ^
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_subsystem.sv:177:8: Input port connection 'dcache_req_ports_i' expects 218 bits on the pin connection, but pin connection's VARREF 'dcache_req_ports_i' generates 436 bits.
                                                                                                            : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem
  177 |       .dcache_req_ports_i (dcache_req_ports_i),
      |        ^~~~~~~~~~~~~~~~~~
%Warning-WIDTHTRUNC: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_subsystem.sv:178:8: Output port connection 'dcache_req_ports_o' expects 134 bits on the pin connection, but pin connection's VARREF 'dcache_req_ports_o' generates 268 bits.
                                                                                                            : ... In instance ariane_testharness.i_ariane.i_cva6..gen_cache_wt_hyb.i_cache_subsystem
  178 |       .dcache_req_ports_o (dcache_req_ports_o),
      |        ^~~~~~~~~~~~~~~~~~
...
%Warning-LATCH: /home/cai/cache_project//sandbox/cva6/core/csr_regfile.sv:880:3: Latch inferred for signal 'ariane_testharness.i_ariane.i_cva6.en_ld_st_g_translation_csr_ex' (not all control paths of combinational always assign a value)
  ...
  880 |   always_comb begin : csr_update
      |   ^~~~~~~~~~~
%Warning-LATCH: /home/cai/cache_project//sandbox/cva6/core/cache_subsystem/wt_hybche_mem.sv:139:3: Latch inferred for signal 'ariane_testharness.i_ariane.i_cva6.gen_cache_wt_hyb.i_cache_subsystem.i_wt_hybche.i_wt_hybche_mem.fa_hash_idx' (not all control paths of combinational always assign a value)
                                                                                                 : ... Suggest use of always_latch for intentional latches
...
/home/cai/cache_project/sandbox/cva6//work-ver/Variane_testharness   /home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/directed_tests/simple_loop_test.o +debug_disable=1 +ntb_random_seed=1966733276 \
  ++/home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/directed_tests/simple_loop_test.o +elf_file=/home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/directed_tests/simple_loop_test.o +core_name=cv32a60x +config_file=/home/cai/cache_project//sandbox/cva6/config/gen_from_riscv_config/cv32a60x/spike/spike.yaml +tohost_addr=80001000 +signature=/home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/directed_tests/simple_loop_test.o.signature_output +UVM_TESTNAME=uvmt_cva6_firmware_test_c +report_file=/home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/veri-testharness_sim/simple_loop_test.cv32a60x.log.yaml +core_name=cv32a60x
This emulator compiled with JTAG Remote Bitbang client. To enable, use +jtag_rbb_enable=1.
Listening on port 44055
/home/cai/cache_project/sandbox/cva6/verif/sim/out_2025-05-29/directed_tests/simple_loop_test.o *** FAILED *** (tohost = 2147483647) after 2000013 cycles
CPU time used: 54105.73 ms
Wall clock time passed: 54147.82 ms
make: *** [Makefile:418: veri-testharness] Error 255
