...
ida_probe -log -wave=on -wave_probe_args="uvmt_cv32e40s_tb -depth all -all -memories -packed 8192 -unpacked 8192" -sv_all_logs
...
if { [find -scope uvmt_cv32e40s_tb -instance iss_wrap] != ""} {
    ...
    ida_probe -wave -wave_probe_args="uvmt_cv32e40s_tb.iss_wrap.cpu.state.csr    -depth 1"    
}
