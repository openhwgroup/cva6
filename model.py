...
def issue_commit_graph(input_file, n = 3):
    ...
    if input_file is None:
        scores = [[0, 0, 0, 0], [0, 3.4715110446123885, 3.471523096043158, 3.471523096043158], [0, 3.6771600557457464, 5.678688450115561, 5.678688450115561], [0, 3.6771600557457464, 6.1815012393909985, 6.492536828915162]] # pylint: disable=line-too-long
    else:
        r = range(1, n + 1)
        for issue in r:
            for commit in r:
