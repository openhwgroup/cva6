...
def issue_commit_graph(input_file, n = 3):
    ...
    if input_file is None:
        scores = [[0, 0, 0, 0, 0, 0], [0, 3.1986181969389222, 3.198628428130018, 3.198628428130018, 3.198628428130018, 3.198628428130018], [0, 3.5626999565350603, 4.802635686464732, 4.802658751885043, 4.802658751885043, 4.802658751885043], [0, 3.5627888085677943, 5.175260186205861, 5.273482818992976, 5.273482818992976, 5.273482818992976], [0, 3.5627888085677943, 5.368983382996429, 5.581416116897179, 5.581416116897179, 5.581416116897179], [0, 3.5627888085677943, 5.377211378179276, 5.595375981289063, 5.646623037092667, 5.646623037092667]] # pylint: disable=line-too-long
    else:
        r = range(1, n + 1)
        for issue in r:
            for commit in r:
