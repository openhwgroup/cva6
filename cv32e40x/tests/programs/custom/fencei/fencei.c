...
static volatile uint32_t *vp_enab_ptr = (CV_VP_FENCEI_TAMPER_BASE + 0);
static volatile uint32_t *vp_addr_ptr = (CV_VP_FENCEI_TAMPER_BASE + 4);
static volatile uint32_t *vp_data_ptr = (CV_VP_FENCEI_TAMPER_BASE + 8);
