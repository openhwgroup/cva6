...
#    tb/common/mock_uart.sv \
    ...
    -Wno-BLKANDNBLK \
    -Wno-style \
    -LDFLAGS "-L/opt/riscv64/lib -L/opt/riscv64/lib -Wl,-rpath,/opt/riscv64/lib -Wl,-rpath,/opt/riscv64/lib -lfesvr  -lpthread" \
    -CFLAGS "-I/include -I/opt/riscv64/include -I/opt/riscv64/include  -std=c++11 -I../tb/dpi " \
    -Wall \
    --cc \
    --vpi \
