...
if {$::env(BOARD) eq "genesys2"} {
  ...
  set_property PROGRAM.FILE {work-fpga/cva6_xilinx.bit} [get_hw_devices xc7k325t_0]
  ...
  set_property PROGRAM.FILE {work-fpga/cva6_xilinx.bit} [get_hw_devices xc7vx485t_0]
